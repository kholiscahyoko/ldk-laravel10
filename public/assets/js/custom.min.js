...
function convertToLongDate(isodate){
    if(typeof isodate === null){
        return null;
    }
...
function getMaterialDesc(el){
    document.getElementById('ldk_description').value = '';
    var xhr = new XMLHttpRequest();

    xhr.open('GET', `/master_bk/get_by_material_number/${el.value}`, true);
    xhr.onreadystatechange = function () {
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            document.getElementById('ldk_description').value = data.material_desc;
