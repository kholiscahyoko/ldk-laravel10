...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('master_bk', function (Blueprint $table) {
            ...
            $table->string('desc_item')->comment('Label of material number. Assigned by Purchasing Admin');
            $table->string('maker')->comment('Institution where BK comes from. Assigned by Purchasing Admin');
            $table->binary('ldk_fr_maker')->nullable()->comment('ldk document from maker. Assigned by Purchasing Admin');
